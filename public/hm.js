(function () {
  var h = {},
    mt = {},
    c = {
      id: "9082e1fe6a271fcde89eef62943ec0f0",
      dm: ["labelbee.sensebee.xyz"],
  ...
  mt.cookie.fc = function (a, b) {
    try {
      ...
      mt.cookie.set(d, "is-cookie-enabled", { domain: a, path: b, Q: s });
      var e = "is-cookie-enabled" === mt.cookie.get(d) ? "1" : "0";
      mt.cookie.set(d, "", { domain: a, path: b, Q: -1 });
      return e;
    } catch (f) {
      return "0";
    }
  ...
  mt.lang.find = function (a, b, d) {
    for (var e = a.length, f = 0; f < e; f++)
      if (f in a && b.call(d || a, a[f], f)) return a[f];
    return v;
  };
  mt.lang.filter = function (a, b, d) {
    ...
    if (mt.lang.w(b))
      for (l = 0; l < m; l++)
        if (((g = a[l]), u === b.call(d || a, g, l))) e[f++] = g;
    return e;
  };
  ...
  mt.lang.Lc = function (a, b) {
    ...
    var f = d(a),
      m = d(b);
    return parseInt(
      (e + ((f[0] | m[0]) >>> 0).toString(2)).slice(-32) +
        (e + ((f[1] | m[1]) >>> 0).toString(2)).slice(-32),
      2
    );
  };
  mt.url = {};
  ...
  (function () {
    ...
    mt.f.qa = function (a) {
      ...
      try {
        ...
        for (
          var e = a.split(">"), b = document.body, m = e.length - 1;
          0 <= m;
          m--
        )
          if (-1 < e[m].indexOf("#")) {
            ...
            (b = document.getElementById(g)) ||
              (b = document.getElementById(decodeURIComponent(g)));
    ...
    mt.f.sa = function (a, e) {
      ...
      for (; a.parentNode != v; ) {
        for (
          var g = 0, l = 0, p = a.parentNode.childNodes.length, q = 0;
          q < p;
          q++
        ) {
    ...
    mt.f.Lb = function (a) {
      ...
      return {
        ...
        left:
          e.left + (window.pageXOffset || b.scrollLeft) - (b.clientLeft || 0),
      };
    };
    mt.f.getAttribute = function (a, e) {
      var b = (a.getAttribute && a.getAttribute(e)) || v;
      if (!b && a.attributes && a.attributes.length)
        for (var m = a.attributes, g = m.length, l = 0; l < g; l++)
          m[l].nodeName === e && (b = m[l].nodeValue);
      return b;
    };
    mt.f.S = function (a) {
      var e = "document";
    ...
    mt.f.Rb = function (b) {
      var e = "";
      b.textContent
        ? (e = a.trim(b.textContent))
        : b.innerText && (e = a.trim(b.innerText));
    ...
    mt.f.R = function (d, e) {
      ...
      a.I(d) && 0 === String(d).indexOf("!HMCQ!")
        ? ((f = String(d)),
          (f = b.j("https://labelbee-Client-0_2_2.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0], f.substring(6, f.length))))
        : a.I(d) ||
          ((f = mt.f.S(d)),
          "input" === f && e && ("button" === d.type || "submit" === d.type)
            ...
            : "img" === f
            ? ((f = mt.f.getAttribute),
              (f = f(d, "alt") || f(d, "title") || f(d, "src")))
            : (f =
                "body" === f || "html" === f
                  ? ["(hm-default-content-for-", f, ")"].join("")
                  : mt.f.Rb(d)));
        ...
        (function () {
          if (!f)
            if (((f = u), "complete" === document.readyState)) a.ea = u;
              ...
              document.addEventListener("DOMContentLoaded", g, w),
    ...
    try {
      window.localStorage
        ...
        : mt.localStorage.ka() &&
          ...
          mt.localStorage.l.load("labelbee-Client-0_2_2.sensebee.xyz"),
          mt.localStorage.l.setAttribute(a, b),
          mt.localStorage.l.save("labelbee-Client-0_2_2.sensebee.xyz"));
    } catch (f) {}
  };
  ...
  mt.jb.Sb = function () {
    ...
    if (navigator.plugins && navigator.mimeTypes.length) {
      ...
      b &&
        b.description &&
        (a = b.description.replace(/^.*\s+(\S+)\s+\S+$/, "$1"));
    } else if (window.ActiveXObject)
      try {
        if ((b = new ActiveXObject("ShockwaveFlash.ShockwaveFlash")))
          (a = b.GetVariable("$version")) &&
            (a = a.replace(/^.*\s+(\d+),(\d+).*$/, "$1.$2"));
      } catch (d) {}
    return a;
  };
  h.D = {
      ...
      d = {
        ...
        Ya: function (a, b) {
          return (
            ...
            d.Za("https://labelbee-Client-0_2_2.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0], a, b)
          );
        },
        Za: function (a, f, d) {
          if (a === s) return w;
          ...
          if (!a.m(m, "Undefined")) {
            ...
            if (a.g(m)) {
              var g = [],
                l;
              for (l in m)
                m.hasOwnProperty(l) && d.Ya(l, f) && (g = g.concat(m[l]));
              return g;
            }
          }
        },
    ...
    var a = mt.url,
      ...
      f = {
        ...
        setData: function (a, g, l) {
          try {
            b.set(a, g, { domain: f.ca(), path: f.pa(), Q: l }),
              l ? d.set(a, g, l) : e.set(a, g);
          } catch (p) {}
        },
        removeData: function (a) {
          try {
            b.set(a, "", { domain: f.ca(), path: f.pa(), Q: -1 }),
              e.remove(a),
              d.remove(a);
          } catch (g) {}
        },
        ca: function () {
          for (
            var b = "labelbee-Client-0_2_2.sensebee.xyz", e = 0, f = c.dm.length;
            e < f;
            e++
          )
        ...
        pa: function () {
          for (var b = 0, e = c.dm.length; b < e; b++) {
            var f = c.dm[b];
            if (-1 < f.indexOf("/") && a.Xa("https://labelbee-Client-0_2_2.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0], f))
              return f.replace(/^[^/]+(\/.*)/, "$1") + "/";
          }
          return "/";
        },
      ...
      l = {
              ...
              if (d.hasOwnProperty(x)) {
                ...
                if (
                  ...
                  if (n == v) delete r[k];
                    ...
                    n = a.h(String(n));
                    l.ec(f, k, n) && (r[k] = { value: n, scope: l.Ra(f) });
                  }
                }
              }
            "user" === f && l.Ea();
        ...
        ec: function (a, b, f) {
          var r = u,
            d = e[a];
          if (
            256 < encodeURIComponent(String(b)).length ||
            256 < encodeURIComponent(String(f)).length
          )
            r = w;
          else {
            var k = d[b];
            d[b] = { value: f, scope: l.Ra(a) };
            a = l.K(l.t(a));
            2048 < encodeURIComponent(a).length &&
              (k !== s ? (d[b] = k) : delete d[b], (r = w));
          }
          return r;
        },
        K: function (a) {
      ...
      e = {
        ...
        jc: function (a, b) {
          return function (e) {
            ...
            a &&
              a.s &&
              (b ? a.s(b) : a.s("#" + encodeURIComponent(this.id), e.type));
          };
        },
      };
    return (h.yb = e);
      ...
      p = {
        ...
        Eb: function (b, f) {
          ...
          d &&
            (c.aet && c.aet.length
              ? ((b.ei_ =
                  a.getAttribute(d, g.id) || a.getAttribute(d, "id") || ""),
                (b.ec_ =
                  a.getAttribute(d, g.Z) || a.getAttribute(d, "class") || ""),
                (b.ex_ = a.getAttribute(d, g.Y) || a.ta(d)),
                (b.en_ = a.getAttribute(d, g.content) || a.R(d, u)),
                (b.et_ = a.getAttribute(d, g.ga) || a.S(d)),
                (b.el_ =
                  a.getAttribute(d, g.link) || a.getAttribute(d, "href") || ""))
              : ((b.ex_ = a.getAttribute(d, g.Y) || a.ta(d)),
                (b.en_ = a.getAttribute(d, g.content) || a.R(d, u))));
          return b;
        },
      ...
      t = {
        ...
        Hb: function (d) {
          ...
          if (
            ...
            (A = A.top),
            a.w(f.getBBox) &&
              ((g = f.getBBox()), (n = g.width), (g = g.height)),
          ...
          return {
            ...
            Ia: n,
            va: g,
            Ga: ("a" === (f.tagName || "").toLowerCase() ? f : b.Db(f))
              ? "a"
              : "b",
          };
        },
        ...
        ma: function (a) {
          var b = f.Pa;
          a.length > b ||
            (encodeURIComponent(q.join("!") + a).length > b &&
              0 < q.length &&
              (t.s(q.join("!")), (q = [])),
            q.push(a));
        },
        s: function (a) {
          h.c.b.et = 5;
          h.c.b.ep = a;
          g.setProperty("autoEventTracking", { view_h_: e.G() }, u);
  ...
  (function () {
    var a = mt.lang,
      ...
      r = {
        ...
        ma: function (a) {
          if (encodeURIComponent(p.join("!") + a).length > e.Pa || 3 < p.length)
            r.s(p.join("!")), (p = []);
          p.push(a);
        },
        s: function (a) {
          ...
          h.c.b.vh = d.Sa();
          h.c.b.ep = a;
          m.setProperty("autoEventTracking", { view_h_: d.G() }, u);
          h.c.b.p = g(m.t("autoEventTracking"));
          h.c.n();
          h.c.b.p = "";
          m.setProperty("autoEventTracking", { view_h_: v }, u);
        },
        X: function () {
          return function () {
  ...
  (function () {
    var a = mt.lang,
      ...
      f = {
        $b: function (f) {
          if (
            (window._dxt === s || a.m(window._dxt, "Array")) &&
      ...
      k = {
        ...
        init: function () {
          ...
          l.d("stag-b", function () {
            ...
            h.c.b.ct = [
              decodeURIComponent(t.getData("Hm_ct_" + c.id) || ""),
              k.C.Ha,
              k.C.page,
            ].join("!");
          });
        ...
        zb: function () {
          ...
          a.cmd[c.id] = { push: k.Fa };
        },
        Ab: function () {
          if (0 < k.W.length)
            for (var a = 0, b = k.W.length; a < b; a++) k.Fa(k.W[a]);
          k.W = v;
        },
        Fa: function (a) {
          var b = a[0];
        ...
        _trackPageview: function (a) {
          1 < a.length &&
            ...
            k.ya || (h.c.b.su = h.c.b.u || "https://labelbee-Client-0_2_2.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0]),
            (h.c.b.u = g.protocol + "//" + "labelbee-Client-0_2_2.sensebee.xyz" + a[1]),
        ...
        _setCustomVar: function (a) {
          if (!(4 > a.length)) {
            ...
            if (0 < b && 6 > b && 0 < f && 4 > f) {
              k.fa++;
              for (
                var d = (h.c.b.cv || "*").split("!"), g = d.length;
                g < b - 1;
                g++
              )
                d.push("*");
        ...
        _setReferrerOverride: function (a) {
          1 < a.length &&
            ...
            e.m(a, "String")
              ? ((h.c.b.su =
                  "/" === a.charAt(0)
                    ? g.protocol + "//" + "labelbee-Client-0_2_2.sensebee.xyz" + a
                    : a),
                (k.ya = u))
              : (k.ya = w));
        },
        ...
        _trackMobConv: function (a) {
          if (
            (a = { webim: 1, tel: 2, map: 3, sms: 4, callback: 5, share: 6 }[
              a[1]
            ])
          )
          ...
          if (1 < a.length) {
            ...
            if (
              ...
              for (var f = 0, k = a.length; f < k; f++) {
                var l = a[f][2] || {};
                if (b.plugins[d] && !b.J[d])
                  (b.J[d] = new b.plugins[d](l)), b.B.shift();
                else break;
              }
          }
        },
          ...
          if (1 < a.length) {
            ...
            if (e.H(g.eb, d))
              if (
                ...
                b.B = b.B || [];
                for (var f = 0, l = b.B.length; f < l; f++)
                  if (b.B[f][1] === d) return;
                b.B.push(a);
  ...
  (function () {
    ...
    c.spa !== s &&
      ...
      a.d("pv-b", function () {
        "" !== window.location.hash && (h.c.b.u = "https://labelbee-Client-0_2_2.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0]);
      }));
  })();
  (function () {
    function a() {
    ...
    a.prototype = {
      ...
      Qb: function () {
        ...
        var a = w;
        this.da(document.referrer) && this.da("https://labelbee-Client-0_2_2.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0])
          ? (a = u)
          : ((a = b.T(document.referrer)),
            (a = b.za(a || "", "labelbee-Client-0_2_2.sensebee.xyz")));
      ...
      rc: function () {
        ...
        if (
          0 === c.nv &&
          this.da("https://labelbee-Client-0_2_2.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0]) &&
      ...
      dc: function () {
        var a = b.T("https://labelbee-Client-0_2_2.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0]);
        return !f.H(
      ...
      Bb: function () {
        for (var a = document.cookie.split(";"), b = 0; b < a.length; b++) {
          var d = a[b].split("=");
          d.length &&
            /Hm_(up|ct|cv|lp?vt)_[0-9a-f]{31}/.test(String(d[0])) &&
            t.removeData(d[0]);
          d.length &&
      ...
      sc: function () {
        ...
        this.b.vl = g.G();
        var a = "https://labelbee-Client-0_2_2.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0];
        ...
        try {
          if (window.postMessage && window.self !== window.parent) {
            ...
            window.parent.postMessage(
              {
                id: c.id,
                url: "https://labelbee-Client-0_2_2.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0],
      ...
      qb: function (a) {
        ...
        var e = this.b.u
          ? ""
          : "&u=" + encodeURIComponent("https://labelbee-Client-0_2_2.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0]);
  ...
  c.pt &&
    C(
      [B.protocol, "//ada.baidu.com/phone-tracker/insert_bdtj?sid=", c.pt].join(
        ""
      )
    );
})();
